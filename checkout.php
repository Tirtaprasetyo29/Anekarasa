        ...
        <div class="container">
            ...
            <div class="table-responsive cart_info">
                ...
                <?php endforeach ?>
                    ...
                    <tfoot>
                    <tr>
                        <td class="cart_total_price" colspan="5">Total Belanja</td>
                  ...
                  <form method ="post">
                  <h2>Form Pesanan</h2>
                  <h3>Silahkan lengkapi form di bawah ini untuk melanjutkan ke tahap pembayaran :</h3>
                    <div class="row">
                        <br>
<!-- nama -->
                        <div class="col-md-6">
...
<!-- Alamat -->
                        ...
                        <textarea name="alamat" class="form-control" placeholder="Masukkan Alamat lengkap pengiriman beserta RT, RW, Kelurahan, Kecamatan, dan Kabupater" required></textarea>
                        </div>
                ...
                <?php
                  if(isset($_POST["pembayaran"]))
                  {
                    ...
                    echo "<script>alert('pembelian sukses, silahkan tunggu konfirmasi admin setelah itu melakukan pembayaran');</script>";
