					...
					<div id="slider-carousel" class="carousel slide" data-ride="carousel">
						<ol class="carousel-indicators">
							<?php
								...
								for ($no=0; $no <6 ; $no++) { 
							?>
								<li data-target="#slider-carousel" data-slide-to="<?php echo $no ?>" class="<?php if($no == 0){echo 'active';}else{echo 'notactive';}?>"></li>
							<?php
								};
							?>
						</ol>
						...
						<div class="carousel-inner">
							...
							?>
							<div class="item <?php if($no == 0){echo 'active';}else{echo 'notactive';}?>">
								<div class="col-sm-6">
									...
									<div class="product-image-wrapper">
										<div class="single-products">
												<div class="productinfo text-center">
													...
													<a href="aksi_keranjang.php?id_produk=<?php echo $row['id_produk'];?>" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
												</div>
												<div class="product-overlay">
													<div class="overlay-content">
														...
														<a href="aksi_keranjang.php?id_produk=<?php echo $row['id_produk'];?>" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
														<a href="detailproduk.php?id_produk=<?php echo $row['id_produk'];?>" class="btn btn-default add-to-cart"><i class="fa fa-info-circle"></i>Detail Produk</a>
													</div>
												</div>
										</div>
									</div>
						...
						<div class="panel-group category-products" id="accordian"><!--category-productsr-->
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title"><a href="produk_kategori.php?id_kategori=<?php echo $isi['id_kategori'];?>"><?php echo $isi['nama_kategori']?></a></h4> </h4>
								</div>
							</div>
							<?php } ?>

						</div><!--/category-products-->						<!--Iklan samping -->
							...
							<div class="product-image-wrapper">
								<div class="single-products">
										<div class="productinfo text-center">
											...
											<a href="aksi_keranjang.php?id_produk=<?php echo $duk['id_produk'];?>" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
										</div>
										<div class="product-overlay">
											<div class="overlay-content">
												<h2>Rp. <?php echo $duk['harga'];?></h2>
												<p><?php echo $duk["nama_produk"];?></p>
												<a href="aksi_keranjang.php?id_produk=<?php echo $duk['id_produk'];?>" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
												<a href="detailproduk.php?id_produk=<?php echo $duk['id_produk'];?>" class="btn btn-default add-to-cart"><i class="fa fa-info-circle"></i>Detail Produk</a>
											</div>
										</div>
								</div>
							</div>
...
?>
<section id="testimoni"><!--testimoni-->
