<?php
	...
	$querySimpan = mysqli_query($koneksi, "INSERT INTO tbl_produk (id_kategori, nama_produk, harga, gambar, deskripsi, slide, rekomendasi) VALUES ('$namaKategori', '$namaProduk', '$harga', '$fileName', '$deskripsi', '$slide', '$rekomendasi')");
