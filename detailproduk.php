...
<section class="content">
	<div class="container">
		<div class="row">
			<div class="col-md-6">
			<img src="file/produk/<?php echo $detail["gambar"]?>" alt="" class="img-responsive" />
			</div>
										...
										<span>Rp. <?php echo number_format ($detail["harga"]);?></span>
											<span><form method="post">
												<div class="form-group">
													...
													<input type="number" min="30"  class="form-control" placeholder="Masukkan Jumlah Pesanan, Min 30" name="jumlah" value="30">
													<div class="input-group-btn">
														<button class="btn btn-fefault cart" name="beli"><i class="fa fa-shopping-cart"></i>
														Pesan  
														</button>
													</div>
													</div>
